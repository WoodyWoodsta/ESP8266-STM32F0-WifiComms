...
const uint8_t txString_startServer[] = "AT+CIPSERVER=1,3000\r\n";
...
const uint8_t txString_wifiServerStarted[] = "Wifi Server Started!\r\n";
...
const uint8_t rxString_wifiStartServer[] = "Start Server\r\n";
